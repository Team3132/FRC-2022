 ...
 * {@link #absoluteCartesian(double, double, double) cartesian} and
 * {@link #relativePolar(double, double, double) polar} inputs.
 * <p>
 * This drive train will work for these configurations:
 * <ul>
 * <li>Mecanum - 4 mecanum wheels on the four corners of the robot; or</li>
 * <li>Holonomic - 4 omni wheels arranged so that the front and back wheels are toed in 45 degrees,
 * which form an X across the
 ...
 *
 * <p>
 * <em>NOTE: This class is experimental and needs to be thoroughly tested and debugged using actual
 * hardware.</em>
 *
...
public class MecanumDrive implements Stoppable, Requirable {
     ...
     * @param gyro the gyroscope that will be used to determine the robot's direction for
     *        field-orientated controls; may not be
     *        null
     */
    public MecanumDrive(Motor leftFront, Motor leftRear, Motor rightFront, Motor rightRear,
            AngleSensor gyro) {
     ...
     *
     * @param x The speed that the robot should drive in the X (horizontal) direction. Positive is
     *        right. [-1.0..1.0]
     * @param y The speed that the robot should drive in the Y (vertical) direction. Positive is
     *        forward. [-1.0..1.0]
     * @param rotation The rate of rotation for the robot that is completely independent of the
     *        translation. Positive is
     *        counter-clockwise. [-1.0..1.0]
     * @deprecated in favor of {@link #absoluteCartesian(double, double, double)}. Kept for
     ...
     * @deprecated in favor of {@link #relativePolar(double, double, double)}. Kept for backwards
     *             compatibility.
     */
    @Deprecated
    ...
    /**
     * Cartesian drive method that specifies speeds in terms of the field longitudinal and lateral
     * directions, using the drive's
     * angle sensor to automatically determine the robot's orientation relative to the field.
     * <p>
     * Using this method, the robot will move away from the drivers when the joystick is pushed
    ...
    /**
     * Polar drive method that specifies speeds in terms of magnitude and direction, using the
     * drive's
    ...
    /**
     * Cartesian drive method that specifies speeds in terms of the robot's relative coordinate
     * system.
     * <p>
     * Using this method, the robot will drive similar to conventional driving. Pushing the stick
     * forward will make the
    ...
    /**
     * Polar drive method that specifies speeds in terms of magnitude and direction. This method
     * does not use the drive's angle
     * sensor.
     *
     * @param magnitude The speed that the robot should drive in a given direction.
     * @param direction The direction the robot should drive in degrees. The direction and magnitude
