...
public final class Values {
    ...
    /**
     * Compares two floating point numbers with the {@link #DEFAULT_NUMBER_OF_BITS default
     * tolerance}.
     *
     * @param first the first value
     * @param second the second value
     * @return {@code 0} if both values are within a tolerance of each other; {@code 1} if {@code a}
     *         is greater than {@code b};
    ...
    /**
     * Compares two floating point numbers with a tolerance dictated by the number of bits precision
     * used for the fractional
     * part of the values.
     *
     * @param a the first value
     * @param b the second value
     * @param bits the number of bits of precision
     * @return {@code 0} if both values are within {@code tolerance} of each other; {@code 1} if
     *         {@code a} is greater than
    ...
    /**
     * Calculate the tolerance for the given number of bits of precision. The tolerance is
     * calculated as {@code 1/(2^n)}, where
     * {@code n} is the number of bits. For example, a precision of 4 bits results in a tolerance of
     * 0.0625.
     *
     * @param bits
     * @return
     ...
     *
     * @param minimum the minimum value below which 0.0 is used; must be less than or equal to
     *        {@code maximum}
    ...
    /**
     * Create a {@link DoubleToDoubleFunction function} that limits the input value to to the band
     * between
    ...
    /**
     * Limit values to the band between {@code [-maximum,-minimum]} and {@code [+minimum,+maximum]}
     * (inclusive).
     *
    ...
    public static double symmetricLimit(double minimum, double num, double maximum) {
        if (minimum < 0)
            throw new IllegalArgumentException("The minimum value may not be negative");
        if (maximum < 0)
            throw new IllegalArgumentException("The maximum value may not be negative");
        if (maximum < minimum)
            throw new IllegalArgumentException(
                    "The minimum value must be less than or equal to the maximum value");
        if (num > maximum) {
    ...
    /**
     * Create a {@link DoubleToDoubleFunction function} that limits the input value to the band
     * between
    ...
    /**
     * Begin to create a function that maps from the specified range of input values. To obtain a
     * mapping function, call the
     * {@link RangeMaker#toRange(double, double)} method on the resulting {@link RangeMaker}
     * instance.
     * <p>
     * This is equivalent to calling {@link #mapRange(double, double, double, double)} with the
     * input and output range limits.
     * For example:
     *
     * <pre>
     ...
     */
    public static DoubleToDoubleFunction mapRange(double minInputValue, double maxInputValue,
        ...
        return new DoubleToDoubleFunction() {
            ...
            public double applyAsDouble(double num) {
                ...
                else if (output > maxOutputValue)
                    output = maxOutputValue;
                return output;
            }
        };
    }
