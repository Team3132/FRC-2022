...
/**
 * A {@link TwoAxisAccelerometer} implementation useful for testing, where the two accelerometers
 * are mocks themselves and
 * can be explicitly set in the test case
 * so that the known acceleration values are read by the component that uses an
 * {@link TwoAxisAccelerometer}.
 *
 * @author Randall Hauch
 */
@Immutable
public class MockThreeAxisAccelerometer extends MockTwoAxisAccelerometer
        implements ThreeAxisAccelerometer {
