...
/**
 * A {@link Switch} implementation useful for testing, where the triggered state can be explicitly
 * set in the test
 * case so that component using the Switch can determine if it is triggered.
 *
 */
public class MockSwitchImplementation implements MockSwitch {
     ...
     * @return this object to allow chaining of methods; never null
     */
    public MockSwitchImplementation setTriggered() {
        setTriggered(true);
        return this;
    }
     ...
     * @return this object to allow chaining of methods; never null
     */
    public MockSwitchImplementation setNotTriggered() {
        setTriggered(false);
        return this;
    }
