...
/**
 * A {@link Controller} implementation that tests can use to manually {@link #setValue(double) set
 * the value}.
 */
public class MockPIDController extends MockController implements PIDController {
    ...
    @Override
    public synchronized MockPIDController withProfile(int profile, double p, double i, double d,
            double feedForward) {
