...
/**
 * An {@link AngleSensor} implementation useful for testing, where the angle can be explicitly set
 * in the test case so that the
...
public class MockEncoder extends MockAngleSensor {
     ...
     */
    public MockEncoder setAngle(double angle) {
        super.setValue(angle);
        return this;
    }

    public MockEncoder setDistancePerPulse(double distance) {
        return this;
    }
