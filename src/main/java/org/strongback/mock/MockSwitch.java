...
/**
 * A switch is any readable device that has an active state when it is triggered and an inactive
 * state when it isn't.
 *
...
@ThreadSafe
@FunctionalInterface
public interface MockSwitch extends Switch {
    /**
     ...
     */
    public static MockSwitch alwaysTriggered() {
        return () -> true;
    }
     ...
     */
    public static MockSwitch neverTriggered() {
        return () -> false;
    }
     ...
     */
    public static MockSwitch and(MockSwitch switch1, MockSwitch switch2) {
     ...
     */
    public static MockSwitch or(MockSwitch switch1, MockSwitch switch2) {
        Objects.requireNonNull(switch1, "The first switch may not be null");
        Objects.requireNonNull(switch2, "The second switch may not be null");
        if (switch1 == switch2)
            return switch1;
