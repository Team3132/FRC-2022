...
/**
 * A {@link Controller} extension for Proportional Integral Differential (PID) controllers with
 * optional support for feed
 * forward.
 *
 * <h2>Profiles</h2>
 * <p>
 * Each PIDController instance is able to have 1 or more independent sets of PID gains, called
 * <em>profiles</em>. One of these
...
public interface PIDController extends Controller {
    ...
    /**
     * Set the control gains for the specified profile, which may or may not be the current profile.
     * Profile numbers start from
     * 0 and can include any integers, although consecutive non-zero numbers are encouraged. The
     * default profile is
     * {@value #DEFAULT_PROFILE}.
     *
     * @param profile the profile number; a new profile will be created if a profile with the number
     *        does not exist may be an
