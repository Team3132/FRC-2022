...
public interface DataRecorder {
    /**
     * Registers by name a function that will be periodically polled to obtain and record an integer
    ...
    /**
     * Registers by name a function that will be periodically polled to obtain a double value and
     * scale it to an integer value
     * that can be recorded. This method will remove any previously-registered supplier, switch, or
     * motor with the same name.
     *
     * @param name the name of this data supplier
     * @param scale the scale factor to multiply the supplier's double values before casting to an
     *        integer value
     * @param supplier the {@link IntSupplier} of the value to be logged
     * @return this instance so methods can be chained together; never null
     * @throws IllegalArgumentException if the {@code supplier} parameter is null
    ...
    /**
     * Registers by name a switch that will be periodically polled to obtain and record the switch
     * state. This method will
     * remove any previously-registered supplier, switch, or motor with the same name.
     *
    ...
    /**
     * Registers by name a speed sensor that will be periodically polled to obtain and record the
     * current speed. This method
    ...
    /**
     * Registers by name a recordable object that likely has multiple channels. This method will
     * remove any
