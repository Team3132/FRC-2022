 ...
 * <li>{@link #INTERUPTED} - The {@link Command} has been interrupted, but it has not been
 * processed.</li>
...
public enum CommandState {
    ...
    UNINITIALIZED,
    /**
     * The {@link Command} has been {@link Command#initialize() initialized} and is ready to
     * {@link Command#execute() executed}.
     */
    RUNNING,
    /**
     * The {@link Command} has completed {@link #RUNNING running} (because {@link Command#execute()}
     * returned {@code true}).
     */
    FINISHED,
    /**
    ...
    FINALIZED,
    /**
     * The {@link Command} has been interrupted before completion, but the interrupt has not been
     * processed.
     */
    INTERUPTED,
}
