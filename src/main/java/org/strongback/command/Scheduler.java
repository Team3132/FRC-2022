...
public class Scheduler implements Executable {
        ...
        if (command instanceof CommandGroup) {
            ...
            switch (cg.getType()) {
                ...
                case FORK:
                    ...
                    return new CommandRunner(context, last,
                            new CommandRunner(context, buildRunner(commands[0], null)));
            }
     ...
     *
     * @return {@code true} if there are no {@link Command}s executing or pending; {@code false}
     *         otherwise
     */
