...
public interface TwoAxisAccelerometer {
    ...
    /**
     * Get the accelerometer for the axis with the given index, where 0 is the X-axis and 1 is the
     * Y-axis.
     *
    ...
    default public Accelerometer getDirection(int axis) {
        ...
        throw new IllegalArgumentException(
                "The axis was '" + axis + "', but only '0' or '1' is accepted");
    }
    ...
    default public TwoAxisAcceleration getAcceleration() {
        return new TwoAxisAcceleration(getXDirection().getAcceleration(),
                getYDirection().getAcceleration());
    }
