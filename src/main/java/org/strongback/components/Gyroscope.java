...
/**
 * A gyroscope is a device that measures angular velocity (in degrees per second) about a single
 * axis. A gyroscope can
 * indirectly determine angular displacement by integrating velocity with respect to time, which is
 * why it extends
 * {@link Compass}. Negative values are assumed to be counter-clockwise and positive values are
 * clockwise.
 *
...
public interface Gyroscope extends Compass {
    /**
     * Gets the rate of change in {@link #getAngle()} of this {@link Gyroscope} in degrees per
     * second.
     *
    ...
    /**
     * Create a gyroscope for the given functions that returns the angular displacement and
     * velocity.
     *
