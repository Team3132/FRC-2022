...
public interface PneumaticsModule {
    ...
    /**
     * Get the relay that controls whether the module automatically runs the compressor when the
     * {@link #lowPressureSwitch()} is
     * triggered and shuts if off when the switch is untriggered (i.e., the maximum pressure
    ...
    /**
     * Get the faults currently associated with the compressor. These state of these faults may
    ...
    /**
     * Get the sticky faults associated with the compressor. Once these faults are triggered, they
     * are only reset with
     * #clearStickyFaults
     *
    ...
    /**
     * Clear all {@link #compressorStickyFaults() sticky compressor faults} that may have been
     * triggered.
     * 
    ...
    public static interface Faults {
        ...
        /**
         * The switch that is {@link Switch#isTriggered() triggered} when the compressor is not
         * connected.
         * 
        ...
        /**
         * The switch that is {@link Switch#isTriggered() triggered} when the compressor current is
         * too high.
         * 
         * @return the switch; never null
         */
