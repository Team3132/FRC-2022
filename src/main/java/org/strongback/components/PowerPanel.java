...
public interface PowerPanel {
    ...
    /**
     * Gets the temperature of this {@link PowerPanel} in degrees Celsius. This is equivalent to
     * calling
    ...
    /**
     * Create a new PowerPanel from functions that supply the current for each channel, total
     * current, voltage, and temperature.
     *
     * @param currentForChannel the function that returns the current for a given channel; may not
     *        be null
     ...
     */
    public static PowerPanel create(IntToDoubleFunction currentForChannel,
            DoubleSupplier totalCurrent, DoubleSupplier voltage,
     ...
     * current, voltage, and temperature.
     *
     * @param currentSensorForChannel the function that returns the current sensor for a given
     *        channel; may not be null
     ...
     * @see Hardware#powerPanel()
     */
    public static PowerPanel create(Function<Integer, CurrentSensor> currentSensorForChannel,
            CurrentSensor totalCurrent,
