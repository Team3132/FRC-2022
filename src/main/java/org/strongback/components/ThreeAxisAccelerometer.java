...
/**
 * An accelerometer is a device capable of sensing acceleration. By performing two integrations, an
 * accelerometer can also find
...
public interface ThreeAxisAccelerometer extends TwoAxisAccelerometer {
    ...
    /**
     * Get the accelerometer for the axis with the given index, where 0 is the X-axis, 1 is the
    ...
    default public Accelerometer getDirection(int axis) {
        ...
        throw new IllegalArgumentException(
                "The axis was '" + axis + "', but only '0', '1', or '2' is accepted");
    }
    ...
    default public ThreeAxisAcceleration getAcceleration() {
        return new ThreeAxisAcceleration(getXDirection().getAcceleration(),
                getYDirection().getAcceleration(), getZDirection()
                        .getAcceleration());
    }
     ...
     */
    public static ThreeAxisAccelerometer create(Accelerometer xAxis, Accelerometer yAxis,
            Accelerometer zAxis) {
    ...
    /**
     * Create a 3-axis accelerometer from a 2-axis accelerometer and a separate accelerometer for
     * the Z-axis.
     * 
